...
export function NotificationProvider({ children }: { children: React.ReactNode }) {
  ...
  // Load cached notifications on mount only (no auto-fetch here)
  useEffect(() => {
    (async () => {
  ...
  const requestPushPermissions = useCallback(async () => null, []);

  // No local notification sending
